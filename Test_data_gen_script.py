...
# # COST2100 data
# log_path = os.path.join(log_dir,"Dataset", "Benchmark_Data_COST2100", "Test")
# Train_dict            = scipy.io.loadmat(os.path.join(log_path,"DATA_Htestin.mat"))
...
# )
Train_dict            = scipy.io.loadmat(os.path.join(log_path,"test.mat"))
...
# np.save("H_compressed_COST2100_test_512.npy", Y)
# np.save("H_compressed_Quadriga_test_128.npy", Y)


# Create an output directory for the pickled vectors
codeword_dir = "pickle_vectors_test"
# SAVE_DIR = os.path.join(log_dir,"Dataset", "Benchmark_Data_COST2100", "Test",codeword_dir)
